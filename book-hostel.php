...
$query="insert into  registration(roomno,seater,feespm,stayfrom,duration,roomname,roomfemale,course,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiiisisissssisississsisssi',$roomno,$seater,$feespm,$stayfrom,$duration,$roomname,$roomfemale,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
echo"<script>alert('Student Registration Succssfully');</script>";
}
?>
...
<div class="form-group">
<label class="col-sm-2 control-label">Choose room name for male hostel</label>
<div class="col-sm-8">
<select name="roomname" id="roomname" class="form-control">
<option value="">Choose room name for male hostel</option>
...
<div class="form-group">
<label class="col-sm-2 control-label">Choose room name for female hostel</label>
<div class="col-sm-8">
<select name="roomfemale" id="roomname" class="form-control">
<option value="">Choose room name for female hostel</option>
